...
def local_sparsity_before_par_wrapper(X, freq_width_energy=41, freq_width_sparsity=17, time_width=13):
    #print(f"freq_width_sparsity = {freq_width_sparsity}\nfreq_width_energy = {freq_width_energy}\ntime_width = {time_width}")
    return local_sparsity_before_par(X, freq_width_energy, freq_width_sparsity, time_width)



@cython.boundscheck(False)
@cython.wraparound(False) 
cdef local_sparsity_before_par(double[:,:,:] X, Py_ssize_t freq_width_energy, Py_ssize_t freq_width_sparsity, Py_ssize_t time_width):
    cdef:
