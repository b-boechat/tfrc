...
def RTISI_LA(Y_mag, FS, fft_size, w_size, hop_size, output_full_path, LA = None, thresh = 0.01):
    ...
    sf.write(output_full_path, y_reconstruido/np.max(np.abs(y_reconstruido)), FS)
    print(f"Áudio salvo em {output_full_path}")
